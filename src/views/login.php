...
<body class="bg-blue-50 min-h-screen flex items-center justify-center py-12 px-4">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-blue-600 px-6 py-8">
                ...
                <p class="text-blue-100 text-center mt-2">Order food with love</p>
            </div>
            ...
            <div class="px-6 md:px-8 pb-6">
                <p class="text-center text-gray-600 text-sm">
                    ...
                    <a href="/?page=register" class="text-blue-600 font-semibold hover:text-blue-700 transition">Register here</a>
                </p>
            </div>
        </div>
        ...
        <div class="text-center mt-6">
            <a href="/?page=home" class="text-gray-600 hover:text-blue-600 transition text-sm">
