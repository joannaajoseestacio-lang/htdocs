    ...
    <div class="flex flex-col md:flex-row h-screen">
        ...
        <nav class="w-full md:w-64 bg-white shadow-md md:sticky md:top-0">
            <div class="p-6 border-b border-gray-200">
                <div class="bg-gradient-to-r from-blue-500 to-cyan-500 p-3 rounded-lg">
            ...
            <div class="p-6 md:p-8">
                ...
                <div class="mb-12">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-2xl font-bold text-gray-900"><i class="fas fa-list mr-3 text-blue-500"></i>Your Products</h2>
                        <a href="#addProduct" class="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg hover:shadow-lg transition">
                    ...
                    <?php if (!empty($products)): ?>
                        <div class="bg-white rounded-2xl shadow-md overflow-hidden">
                            <div class="overflow-x-auto">
                                <table class="w-full">
                                    <thead class="bg-gradient-to-r from-blue-50 to-cyan-50 border-b">
                                        <tr>
                                    ...
                                    <tbody divide-y">
                                        <?php foreach ($products as $p): ?>
                                            <tr class="hover:bg-blue-50 transition border-b">
                                                ...
                                                <td class="px-6 py-4 text-sm font-bold text-green-600">PHP<?php echo number_format($p['price'], 2); ?></td>
                    ...
                    <?php else: ?>
                        <div class="bg-white rounded-2xl shadow-md p-12 text-center">
                            ...
                            <a href="#addProduct" class="inline-block px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg hover:shadow-lg transition">
                ...
                <!-- Add Product Form -->
                <div id="addProduct" class="bg-white rounded-2xl shadow-md p-8 max-w-3xl">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6"><i class="fas fa-plus-circle mr-3 text-green-500"></i>Add New Product</h2>
                    <form method="post" action="/?page=staff" enctype="multipart/form-data">
                        <input type="hidden" name="action" value="create">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                <label class="block text-sm font-semibold text-gray-700 mb-2">
                                    <i class="fas fa-heading mr-2 text-green-500"></i>Product Name
                                </label>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">
                                    <i class="fas fa-image mr-2 text-green-500"></i>Product Image
                                </label>
                                <input type="file" name="image" accept="image/*" 
                                    class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition">
                            </div>
                        </div>
                        <button type="submit" class="w-full mt-6 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold py-3 rounded-lg hover:shadow-lg transform hover:-translate-y-0.5 transition">
